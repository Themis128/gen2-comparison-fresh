...
export function getPersonalDataServer(): PersonalData {
  return {
    ...
    experience: [
      {
        ...
        description:
          'Resolved over 90% of Cisco infrastructure issues in data centers, ensuring 100% SLA compliance and uninterrupted operations. Streamlined the return merchandise authorization (RMA) process by efficiently creating and tracking labor and parts RMAs, enhancing logistics communication efficiency by 30%. Proactively monitored delivery statuses and resolved logistics challenges, minimizing downtime and boosting service reliability.',
      },
      {
        id: '2',
        title: 'IT Consultant',
        ...
        period: 'Recent - Present',
        description:
          'Specialized in managing and troubleshooting Azure Active Directory services, with focus on secure identity and access management. Maintained robust security protocols in Azure AD, including user provisioning, group management, and implementing access control through RBAC and conditional access policies. Delivered comprehensive support for Microsoft 365 services, resolving end-user issues related to M365 applications. Specialized in mobile device management (MDM) and mobile application management (MAM) using Microsoft Intune.',
      },
      {
        id: '3',
        title: 'IT Consultant',
        ...
        period: 'March 2023',
        description:
          'Provided strategic guidance to organizations, aligning technology initiatives with business goals. Managed and maintained Active Directory environments, including user account provisioning, group management, and access control. Utilized ServiceNow to manage and track IT service requests, incidents, and inventory. Ensured robust Privileged Access Management (PAM) using CyberArk, securing credentials through Vault Management.',
      },
      {
        id: '4',
        ...
        description:
          'Specialized use of Windows and Cisco Systems, servers, switches, routers, hubs, firewalls, LAN, WAN, TCP/IP, DNS, DHCP. Installed and upgraded hardware-based networks, network services, and equipment. Performed troubleshooting analysis of network, servers, workstations, and associated systems. Diagnosed and troubleshot technical issues, including account setup and network configuration.',
      },
      {
        id: '5',
        title: 'TechExpert',
        ...
        description:
          'Developed software fine-tuning (Android, iOS) and hardware repairs of cell phones and tablets. Offered services in repairing desktops and laptops of various brands. Asked customers targeted questions to quickly understand problems and provided prompt feedback. Maintained strong relationships with clients and achieved goals while promoting company products.',
      },
      {
        id: '6',
        title: 'IT Department',
    ...
    projects: [
      {
        ...
        description:
          'Personal portfolio built with Next.js and AWS Amplify, showcasing skills and projects with modern design principles.',
      ...
      },
      {
        ...
        description:
          'Full-stack e-commerce solution with React frontend, Node.js backend, and AWS infrastructure.',
      ...
      },
      {
        ...
        description:
          'Advanced Model Context Protocol server that bridges Windows and Linux file systems. Implements intelligent path resolution algorithms to seamlessly access Windows D: drive paths from Linux environments using WSL. Features include automatic path translation, cross-platform compatibility, and robust error handling for enterprise-grade file operations.',
        technologies: [
          'Node.js',
          'TypeScript',
          'MCP SDK',
      ...
      },
      {
        ...
        description:
          'Comprehensive infrastructure automation solution using Terraform and AWS CDK. Implements Infrastructure as Code principles with automated deployment pipelines, monitoring, and scaling capabilities for cloud-native applications.',
        technologies: [
          'Terraform',
          'AWS CDK',
          'Docker',
      ...
      },
      {
        ...
        description:
          'Advanced VS Code extension ecosystem providing AI-powered UI development tools, component generation, and design-to-code capabilities. Features include magic component builder, design inspiration system, and integrated development workflow enhancements.',
        technologies: [
          'TypeScript',
          'React',
          'Node.js',
      ...
      },
      {
        ...
        description:
          'Comprehensive research thesis on advanced data analytics techniques and methodologies. Explores machine learning applications, predictive modeling, and data-driven decision making frameworks for modern business intelligence solutions.',
        technologies: [
          'Python',
          'Pandas',
          'Scikit-Learn',
        ...
        github:
          'https://github.com/themis128/my-portfolio-aws/tree/main/Bolton_University_Thesis_Synopsis_Proposal',
      ...
      },
      {
        ...
        description:
          'Interactive web application for time series forecasting using XGBoost algorithms. Features real-time data visualization, model training interfaces, and predictive analytics dashboards for business intelligence and decision support systems.',
        technologies: [
          'Python',
          'Streamlit',
          'XGBoost',
    ...
    achievements: [
      {
        ...
        description:
          'Resolved over 90% of Cisco infrastructure issues in data centers, ensuring 100% SLA compliance and uninterrupted operations.',
        date: '2024',
        type: 'Award',
      },
      {
        ...
        description:
          'Streamlined the return merchandise authorization (RMA) process, enhancing logistics communication efficiency by 30%.',
        date: '2024',
        type: 'Award',
      },
      {
        ...
        description:
          'Achieved a 15% improvement in system uptime for over 500 users through effective IT infrastructure management.',
        date: '2006',
        type: 'Award',
      },
      {
        ...
        description:
          'Drove a 20% enhancement in organizational productivity through deployment of innovative technology solutions.',
        date: '2006',
        type: 'Award',
      },
      {
        ...
        description:
          'Led to a 30% reduction in support ticket resolution time through comprehensive training and technical support delivery.',
        date: '2006',
        type: 'Award',
      },
      {
        ...
        description:
          'Earned AWS Certified Cloud Practitioner certification, demonstrating knowledge of AWS Cloud concepts, services, and terminology.',
        date: '2023',
        type: 'Award',
      },
      {
        ...
        description:
          'Achieved Cisco DevNet Associate certification, showcasing skills in software development and design for Cisco platforms.',
        date: '2024',
        type: 'Award',
      },
    ],
    company: {
      ...
      mission:
        'To leverage technology and data analytics to create meaningful solutions that help businesses and individuals achieve their goals in an increasingly digital world.',
      vision:
        'To become a leading expert in data analytics and cloud technologies, contributing to the advancement of digital transformation and innovation.',
      values: [
        'Continuous Learning',
