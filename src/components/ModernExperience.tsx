      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute bottom-0 left-8 top-0 w-0.5 bg-gradient-to-b from-blue-400 to-purple-400" />

            <motion.div
              className="absolute left-8 top-0 w-0.5 origin-top bg-primary"
              initial={{ scaleY: 0 }}
              whileInView={{
                scaleY: 1,
                transition: {
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-4 sm:gap-6">
                      ...
                      >
                        <Card
                          className={`relative border bg-card/50 backdrop-blur-sm transition-all duration-300 hover:shadow-md ${config.borderColor} group-hover:border-primary/30`}
                        >
                          <CardContent className="p-4 sm:p-6">
                            <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
                              ...
                              <Badge
                                className={`w-fit border text-xs font-medium ${config.badgeBg} ${config.badgeText} border-current/20`}
                              >
            ...
            {/* Timeline end marker */}
            <motion.div
              className="absolute -bottom-6 left-8 -translate-x-1/2 transform"
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center space-x-3 rounded-full border border-border/50 bg-background/60 px-8 py-4 shadow-lg backdrop-blur-sm">
              <span className="font-medium text-muted-foreground">
                Always evolving and embracing new challenges
              </span>
              <motion.div
                animate={{ rotate: 360 }}
